...
class ApartamentosTableMap extends TableMap
{
     ...
     */
    const COL_DIRECCION = 'apartamentos.direccion';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Direccion', 'Descripcion', 'Precio', 'Latitud', 'Longitud', 'IdComentario', 'IdTipo', ),
        self::TYPE_CAMELNAME     => array('id', 'direccion', 'descripcion', 'precio', 'latitud', 'longitud', 'idComentario', 'idTipo', ),
        self::TYPE_COLNAME       => array(ApartamentosTableMap::COL_ID, ApartamentosTableMap::COL_DIRECCION, ApartamentosTableMap::COL_DESCRIPCION, ApartamentosTableMap::COL_PRECIO, ApartamentosTableMap::COL_LATITUD, ApartamentosTableMap::COL_LONGITUD, ApartamentosTableMap::COL_ID_COMENTARIO, ApartamentosTableMap::COL_ID_TIPO, ),
        self::TYPE_FIELDNAME     => array('id', 'direccion', 'descripcion', 'precio', 'latitud', 'longitud', 'id_comentario', 'id_tipo', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Direccion' => 1, 'Descripcion' => 2, 'Precio' => 3, 'Latitud' => 4, 'Longitud' => 5, 'IdComentario' => 6, 'IdTipo' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'direccion' => 1, 'descripcion' => 2, 'precio' => 3, 'latitud' => 4, 'longitud' => 5, 'idComentario' => 6, 'idTipo' => 7, ),
        self::TYPE_COLNAME       => array(ApartamentosTableMap::COL_ID => 0, ApartamentosTableMap::COL_DIRECCION => 1, ApartamentosTableMap::COL_DESCRIPCION => 2, ApartamentosTableMap::COL_PRECIO => 3, ApartamentosTableMap::COL_LATITUD => 4, ApartamentosTableMap::COL_LONGITUD => 5, ApartamentosTableMap::COL_ID_COMENTARIO => 6, ApartamentosTableMap::COL_ID_TIPO => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'direccion' => 1, 'descripcion' => 2, 'precio' => 3, 'latitud' => 4, 'longitud' => 5, 'id_comentario' => 6, 'id_tipo' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ApartamentosTableMap::COL_DIRECCION);
