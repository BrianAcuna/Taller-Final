...
class UsuariosTableMap extends TableMap
{
     ...
     */
    const COL_ADMINISTRADOR = 'usuarios.administrador';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Login', 'Password', 'Administrador', ),
        self::TYPE_CAMELNAME     => array('id', 'login', 'password', 'administrador', ),
        self::TYPE_COLNAME       => array(UsuariosTableMap::COL_ID, UsuariosTableMap::COL_LOGIN, UsuariosTableMap::COL_PASSWORD, UsuariosTableMap::COL_ADMINISTRADOR, ),
        self::TYPE_FIELDNAME     => array('id', 'login', 'password', 'administrador', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Login' => 1, 'Password' => 2, 'Administrador' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'login' => 1, 'password' => 2, 'administrador' => 3, ),
        self::TYPE_COLNAME       => array(UsuariosTableMap::COL_ID => 0, UsuariosTableMap::COL_LOGIN => 1, UsuariosTableMap::COL_PASSWORD => 2, UsuariosTableMap::COL_ADMINISTRADOR => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'login' => 1, 'password' => 2, 'administrador' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('administrador', 'Administrador', 'BOOLEAN', true, 1, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuariosTableMap::COL_ADMINISTRADOR);
        } else {
