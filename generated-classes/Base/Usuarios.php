...
abstract class Usuarios implements ActiveRecordInterface
{
    ...
    public function setAdministrador($v)
    {
        ...
        if ($this->administrador !== $v) {
            ...
            $this->modifiedColumns[UsuariosTableMap::COL_ADMINISTRADOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsuariosTableMap::translateFieldName('Login', TableMap::TYPE_PHPNAME, $indexType)];
            $this->login = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UsuariosTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            $this->password = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsuariosTableMap::translateFieldName('Administrador', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_ADMINISTRADOR)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_ADMINISTRADOR)) {
            $criteria->add(UsuariosTableMap::COL_ADMINISTRADOR, $this->administrador);
        }
