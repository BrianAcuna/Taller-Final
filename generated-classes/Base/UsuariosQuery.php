 ...
 * @method     ChildUsuariosQuery orderByAdministrador($order = Criteria::ASC) Order by the administrador column
 *
 ...
 * @method     ChildUsuariosQuery groupByAdministrador() Group by the administrador column
 *
 ...
 * @method     ChildUsuarios findOneByAdministrador(boolean $administrador) Return the first ChildUsuarios filtered by the administrador column *
 ...
 * @method     ChildUsuarios requireOneByAdministrador(boolean $administrador) Return the first ChildUsuarios filtered by the administrador column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsuarios[]|ObjectCollection findByAdministrador(boolean $administrador) Return ChildUsuarios objects filtered by the administrador column
...
abstract class UsuariosQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'inmobiliaria', $modelName = '\\Usuarios', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, login, password, administrador FROM usuarios WHERE id = :p0';
        try {
    ...
    public function filterByAdministrador($administrador = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsuariosTableMap::COL_ADMINISTRADOR, $administrador, $comparison);
    }
